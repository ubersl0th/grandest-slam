...
export type Database = {
  public: {
    Tables: {
      profiles: Tbl<Profile, Partial<Profile> & { id: string; email: string; full_name: string }>;
    ...
    Views: {
      ...
      team_sport_points: View<{ team_id: string; sport: Sport; points: number }>;
    };
    Functions: {
      submit_match_result: { Args: { p_match_id: string; p_score_a: number; p_score_b: number; p_notes?: string | null }; Returns: Match };
      confirm_match_result: { Args: { p_match_id: string }; Returns: Match };
      dispute_match_result: { Args: { p_match_id: string; p_reason?: string | null }; Returns: Match };
      submit_flight_result: { Args: { p_flight_id: string; p_strokes_1: number; p_strokes_2: number; p_notes?: string | null }; Returns: Flight };
      confirm_flight_result: { Args: { p_flight_id: string }; Returns: Flight };
      dispute_flight_result: { Args: { p_flight_id: string; p_reason?: string | null }; Returns: Flight };
